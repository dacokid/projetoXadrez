...
public class CasaGUI extends JButton {
    ...
    // Constantes 
    public static final Color COR_CLARA = new Color(255, 255, 255);
    public static final Color COR_ESCURA = new Color(51, 54, 202);
    private static final Color COR_DESTAQUE = new Color(0, 1, 0, 0.4f);
    
    // Icones das pecas brancas
    ...
    public int getCorPeca() {
        ...
        if (icone == PEAO_BRANCO || icone == TORRE_BRANCA || icone == CAVALO_BRANCO || icone == BISPO_BRANCO || icone == REI_BRANCO || icone == RAINHA_BRANCA) {
            return PECA_BRANCA;
        }
        else if (icone == PEAO_PRETO || icone == TORRE_PRETA || icone == CAVALO_PRETO || icone == BISPO_PRETO || icone == REI_PRETO || icone == RAINHA_PRETA ) {
             return PECA_PRETA;
        }
        else {
            return SEM_PECA;
